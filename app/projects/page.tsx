			...
			<section className="container">
				<Card className="border-border/90 bg-card/95">
					...
					<CardContent className="grid gap-4 text-sm text-foreground/90 md:grid-cols-3">
						<p>
							<strong>Discover:</strong> clarify user and business constraints
							with engineering feasibility early.
						</p>
						<p>
							<strong>Build:</strong> implement modular services and UI
							workflows with testing and operational visibility.
						</p>
						<p>
							<strong>Improve:</strong> iterate based on usage, defects, and
							performance signals to sustain product value.
						</p>
					</CardContent>
				</Card>
			</section>
