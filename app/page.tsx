			...
			<section className="container grid gap-6 lg:grid-cols-[1.25fr_0.75fr]">
				<Card className="border-border/90 bg-card/95">
					...
					<CardContent className="space-y-4 text-sm leading-relaxed text-foreground/90">
						...
						<p>
							I design and ship production software that balances domain
							reliability, clear product experience, and measurable business
							outcomes. My recent work spans healthcare systems, fintech
							operations, and AI-enabled tooling.
						</p>
					</CardContent>
				</Card>
				...
				<div className="grid gap-5 lg:grid-cols-2">
					{featuredProjects.map((project) => (
						<ProjectCard
							...
							project={project}
							compact
							projectPageHref={`/projects#${projectAnchorId(project.name)}`}
						/>
					))}
				</div>
			</section>
