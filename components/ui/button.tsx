...
export function buttonVariants({
	...
	const byVariant = {
		...
		secondary:
			"bg-card text-foreground ring-1 ring-border hover:bg-background/70",
		outline:
			"bg-transparent text-foreground ring-1 ring-border hover:bg-card/70",
		ghost: "bg-transparent text-foreground hover:bg-card/70",
		cta: "bg-foreground text-background hover:opacity-85",
	};
	const bySize = {
		sm: "h-9 px-4 text-sm",
